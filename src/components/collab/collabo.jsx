const Collabo = () => {
    ...
    <section className='bg-iblack'>
              <div className="grid sm:gaps-y-40 grid-cols-10 pt-40">
                 ...
                 <p className="xl:text-6xl lg:text-3xl md:text-3xl xs:text-4xl sm:text-6xl text-start font-medium text-iwhite break-normal">THE</p>
                                      
                 </div> 

                 <div className="md:col-start-3 md:col-span-3 xs:col-span-8 xs:row-start-2 xs:col-start-2 pb-10">
                 <p className="text-start xl:text-6xl lg:text-3xl md:text-3xl xs:text-4xl sm:text-6xl font-medium text-irouge">COLLABORATION</p>
                 </div>

                 <div className="md:col-start-3 xs:col-start-2 xs:col-end-5 md:col-end-6 row-span-3 xs:pb-10 ">
                 <div className=' container xs:text-center md:text-center xl:text-4xl lg:text-lg md:text-md sm:text-sm xs:text-xs  text-igrey'>
                ...
                <div className="md:col-start-6 xs:col-start-5 xs:col-end-9 md:col-end-10 row-span-3 text-start xl:text-4xl lg:text-lg md:text-md sm:text-sm xs:text-xs  text-igrey  h-710  w-100 pl-10 md:pt-20">
